...
.controller('schedulerAddSiteController',function(schedulerHttpService,$stateParams,$state,$scope){
  	if($stateParams.secondCompanyId && $stateParams.schedulerUUID){
  		$scope.secondCompanyId = $stateParams.secondCompanyId;
  		$scope.schedulerUUID = $stateParams.schedulerUUID;
  	}
        ...
        if(_name!=''&&_address!=''&&_stationType!='' &&_stationType!='站点属性'){
          ...
          var _params = {
            ...
            "secondCompanyId":$scope.secondCompanyId,
          	"schedulerUUID":$scope.schedulerUUID
          }
          ...
          schedulerHttpService.addSite(_params).then(function(result){
              ...
              if(!responseData.error){
                  alertify.alert('新增成功！',function(){
                    $state.go('scheduler.site',{'schedulerUUID':_params.schedulerUUID,'secondCompanyId':_params.secondCompanyId})
                  })
              }else{
